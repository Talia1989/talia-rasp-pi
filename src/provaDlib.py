...
def get_blinking_ratio(eyeType):
...
#         print("bianchi occhio {}: left {}, right {} ".format(occhio, left_side_white, right_side_white))
#         print("gaze_ratio occhio {}: {}".format(occhio, gaze_ratio))
...
for f in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
    ...
    for face in faces:
        ...
        #Detect blinking
        ratioS = get_blinking_ratio("L")
        ratioD = get_blinking_ratio("R") ########################################################
...
#         print("valore maxRatio: {}, valore ratio blink: {}".format(maxRatio, ratioS))
        ...
        #Gaze detection
        left_eye_gaze = get_gaze_ratio("L")
        right_eye_gaze = get_gaze_ratio("R")
